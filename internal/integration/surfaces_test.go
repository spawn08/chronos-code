...
func assertAdapterUsesExecute(t *testing.T, result orchestrator.ExecutionResult) {
	...
	wantKinds := []orchestrator.ContextSourceKind{
		...
		orchestrator.ContextSourceGraphPrediction, orchestrator.ContextSourceRepositoryContext,
		orchestrator.ContextSourceUserHook, orchestrator.ContextSourceWorkingMemory,
	}
