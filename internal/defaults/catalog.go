...
var catalog = map[string]Artifact{
	...
	"agents/delivery-strategist.yaml": {Path: "agents/delivery-strategist.yaml", Activation: RuntimeActive, Rationale: "supplies bounded evidence-driven work frontiers"},
	...
	"agents/tester.yaml":              {Path: "agents/tester.yaml", Activation: RuntimeActive, Rationale: "supplies the default tester prompt"},
